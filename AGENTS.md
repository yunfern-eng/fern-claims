...
Fern Claims — internal tool for PAs and admins to source invoices, match them against credit-card statements, group into monthly claims, and generate executive expenditure summaries.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "333282407+yunfern-eng@users.noreply.github.com"
  git config user.name "yunfern-eng"
  ```
